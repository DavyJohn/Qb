...
public class ShopDetailsItem {
    ...
    public ShopDetailsItem(String id, String sid, String cateid, String brandid, String title, String title_style, String title2, String keywords, String description, String money, String yunjiage, String zongrenshu, String canyurenshu, String shenyurenshu, String def_renshu, String qishu, String maxqishu, String thumb, List picarr, String content, String codes_table, String xsjx_time, String pos, String renqi, String time, String order, String q_uid, String q_user, String q_user_code, String q_content, String q_counttime, String q_end_time, String q_showtime, String q_cai_, String q_cai_dt_, String q_counttime_) {
        this.id = id;
        this.sid = sid;
        this.cateid = cateid;
