...
public class ShopListData  {
    ...
    public String q_cai_;
    public String q_cai_dt_;
    public String q_counttime_;
    public String t_new_goods;
    public String page;
    public String sum;

    public ShopListData(String id, String sid, String cateid, String brandid, String title, String title_style, String title2, String keywords, String description, String money, String yunjiage, String zongrenshu, String canyurenshu, String shenyurenshu, String def_renshu, String qishu, String maxqishu, String thumb, String picarr, String vcontent, String codes_table, String xsjx_time, String pos, String renqi, String time, String order, String q_uid, String q_user, String q_user_code, String q_content, String q_counttime, String q_end_time, String q_showtime, String q_cai_, String q_cai_dt_, String q_counttime_, String t_new_goods, String page, String sum) {
        this.id = id;
        this.sid = sid;
        this.cateid = cateid;
        ...
        this.q_cai_ = q_cai_;
        this.q_cai_dt_ = q_cai_dt_;
        this.q_counttime_ = q_counttime_;
        this.t_new_goods = t_new_goods;
        this.page = page;
        this.sum = sum;
    }
    ...
    public String toString() {
        return "ShopListData{" +
                ...
                ", q_cai_='" + q_cai_ + '\'' +
                ", q_cai_dt_='" + q_cai_dt_ + '\'' +
                ", q_counttime_='" + q_counttime_ + '\'' +
                ", t_new_goods='" + t_new_goods + '\'' +
                ", page='" + page + '\'' +
                ", sum='" + sum + '\'' +
                '}';
    }
